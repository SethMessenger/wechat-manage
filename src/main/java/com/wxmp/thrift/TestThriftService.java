...
@Generated(value = "Autogenerated by Thrift Compiler (0.9.3)", date = "2018-04-08")
public class TestThriftService {
  ...
  public interface Iface {
     ...
     * @param srcStr2
     */
    public com.wxmp.thrift.thriftdatatype.ResultStr getStr(String srcStr1, String srcStr2) throws TException;

    public com.wxmp.thrift.thriftdatatype.ResultInt getInt(int val) throws TException;

  }

  public interface AsyncIface {

    public void getStr(String srcStr1, String srcStr2, AsyncMethodCallback resultHandler) throws TException;

    public void getInt(int val, AsyncMethodCallback resultHandler) throws TException;
  ...
  public static class Client extends org.apache.thrift.TServiceClient implements Iface {
    ...
    public void send_getStr(String srcStr1, String srcStr2) throws TException
    {
    ...
    public com.wxmp.thrift.thriftdatatype.ResultStr recv_getStr() throws TException
    {
    ...
    public void send_getInt(int val) throws TException
    {
    ...
    public com.wxmp.thrift.thriftdatatype.ResultInt recv_getInt() throws TException
    {
  ...
  public static class AsyncClient extends org.apache.thrift.async.TAsyncClient implements AsyncIface {
    ...
    public static class getStr_call extends org.apache.thrift.async.TAsyncMethodCall {
      ...
      public getStr_call(String srcStr1, String srcStr2, AsyncMethodCallback resultHandler, org.apache.thrift.async.TAsyncClient client, org.apache.thrift.protocol.TProtocolFactory protocolFactory, org.apache.thrift.transport.TNonblockingTransport transport) throws TException {
      ...
      public com.wxmp.thrift.thriftdatatype.ResultStr getResult() throws TException {
    ...
    public static class getInt_call extends org.apache.thrift.async.TAsyncMethodCall {
      private int val;
      public getInt_call(int val, AsyncMethodCallback resultHandler, org.apache.thrift.async.TAsyncClient client, org.apache.thrift.protocol.TProtocolFactory protocolFactory, org.apache.thrift.transport.TNonblockingTransport transport) throws TException {
        super(client, protocolFactory, transport, resultHandler, false);
        this.val = val;
      }
      ...
      public com.wxmp.thrift.thriftdatatype.ResultInt getResult() throws TException {
        if (getState() != State.RESPONSE_READ) {
          throw new IllegalStateException("Method call not finished!");
        }
        org.apache.thrift.transport.TMemoryInputTransport memoryTransport = new org.apache.thrift.transport.TMemoryInputTransport(getFrameBuffer().array());
  ...
  public static class Processor<I extends Iface> extends org.apache.thrift.TBaseProcessor<I> implements org.apache.thrift.TProcessor {
    ...
    public static class getInt<I extends Iface> extends org.apache.thrift.ProcessFunction<I, getInt_args> {
      ...
      public getInt_result getResult(I iface, getInt_args args) throws TException {
        getInt_result result = new getInt_result();
  ...
  public static class AsyncProcessor<I extends AsyncIface> extends org.apache.thrift.TBaseAsyncProcessor<I> {
    ...
    public static class getStr<I extends AsyncIface> extends org.apache.thrift.AsyncProcessFunction<I, getStr_args, com.wxmp.thrift.thriftdatatype.ResultStr> {
      public getStr() {
        super("getStr");
      }
      ...
      public AsyncMethodCallback<com.wxmp.thrift.thriftdatatype.ResultStr> getResultHandler(final AsyncFrameBuffer fb, final int seqid) {
        final org.apache.thrift.AsyncProcessFunction fcall = this;
        return new AsyncMethodCallback<com.wxmp.thrift.thriftdatatype.ResultStr>() { 
          public void onComplete(com.wxmp.thrift.thriftdatatype.ResultStr o) {
            getStr_result result = new getStr_result();
            result.success = o;
            try {
      ...
      public void start(I iface, getStr_args args, AsyncMethodCallback<com.wxmp.thrift.thriftdatatype.ResultStr> resultHandler) throws TException {
        iface.getStr(args.srcStr1, args.srcStr2,resultHandler);
      }
    }

    public static class getInt<I extends AsyncIface> extends org.apache.thrift.AsyncProcessFunction<I, getInt_args, com.wxmp.thrift.thriftdatatype.ResultInt> {
      public getInt() {
        super("getInt");
      }
      ...
      public AsyncMethodCallback<com.wxmp.thrift.thriftdatatype.ResultInt> getResultHandler(final AsyncFrameBuffer fb, final int seqid) {
        final org.apache.thrift.AsyncProcessFunction fcall = this;
        return new AsyncMethodCallback<com.wxmp.thrift.thriftdatatype.ResultInt>() { 
          public void onComplete(com.wxmp.thrift.thriftdatatype.ResultInt o) {
            getInt_result result = new getInt_result();
            result.success = o;
            try {
              fcall.sendResponse(fb,result, org.apache.thrift.protocol.TMessageType.REPLY,seqid);
      ...
      public void start(I iface, getInt_args args, AsyncMethodCallback<com.wxmp.thrift.thriftdatatype.ResultInt> resultHandler) throws TException {
  ...
  public static class getStr_result implements org.apache.thrift.TBase<getStr_result, getStr_result._Fields>, java.io.Serializable, Cloneable, Comparable<getStr_result>   {
    ...
    public com.wxmp.thrift.thriftdatatype.ResultStr success; // required
    ...
    static {
      ...
      tmpMap.put(_Fields.SUCCESS, new org.apache.thrift.meta_data.FieldMetaData("success", org.apache.thrift.TFieldRequirementType.DEFAULT, 
          new org.apache.thrift.meta_data.StructMetaData(org.apache.thrift.protocol.TType.STRUCT, com.wxmp.thrift.thriftdatatype.ResultStr.class)));
      metaDataMap = Collections.unmodifiableMap(tmpMap);
    ...
    public getStr_result(
      com.wxmp.thrift.thriftdatatype.ResultStr success)
    {
      this();
    ...
    public getStr_result(getStr_result other) {
      if (other.isSetSuccess()) {
        this.success = new com.wxmp.thrift.thriftdatatype.ResultStr(other.success);
      }
    }
    ...
    public com.wxmp.thrift.thriftdatatype.ResultStr getSuccess() {
      return this.success;
    }

    public getStr_result setSuccess(com.wxmp.thrift.thriftdatatype.ResultStr success) {
      this.success = success;
      return this;
    }
    ...
    public void setFieldValue(_Fields field, Object value) {
      ...
      case SUCCESS:
        if (value == null) {
          ...
          setSuccess((com.wxmp.thrift.thriftdatatype.ResultStr)value);
        }
        break;
          ...
          switch (schemeField.id) {
            case 0: // SUCCESS
              if (schemeField.type == org.apache.thrift.protocol.TType.STRUCT) {
                struct.success = new com.wxmp.thrift.thriftdatatype.ResultStr();
  ...
  public static class getInt_args implements org.apache.thrift.TBase<getInt_args, getInt_args._Fields>, java.io.Serializable, Cloneable, Comparable<getInt_args>   {
    ...
    private static class getInt_argsStandardScheme extends StandardScheme<getInt_args> {
      ...
      public void read(org.apache.thrift.protocol.TProtocol iprot, getInt_args struct) throws TException {
        org.apache.thrift.protocol.TField schemeField;
        iprot.readStructBegin();
        while (true)
        {
      ...
      public void write(org.apache.thrift.protocol.TProtocol oprot, getInt_args struct) throws TException {
        struct.validate();
    ...
    private static class getInt_argsTupleScheme extends TupleScheme<getInt_args> {
      ...
      @Override
      public void write(org.apache.thrift.protocol.TProtocol prot, getInt_args struct) throws TException {
        TTupleProtocol oprot = (TTupleProtocol) prot;
        BitSet optionals = new BitSet();
        if (struct.isSetVal()) {
          optionals.set(0);
      ...
      @Override
      public void read(org.apache.thrift.protocol.TProtocol prot, getInt_args struct) throws TException {
        TTupleProtocol iprot = (TTupleProtocol) prot;
        BitSet incoming = iprot.readBitSet(1);
        if (incoming.get(0)) {
          struct.val = iprot.readI32();
  ...
  public static class getInt_result implements org.apache.thrift.TBase<getInt_result, getInt_result._Fields>, java.io.Serializable, Cloneable, Comparable<getInt_result>   {
    ...
    public com.wxmp.thrift.thriftdatatype.ResultInt success; // required
    ...
    static {
      Map<_Fields, org.apache.thrift.meta_data.FieldMetaData> tmpMap = new EnumMap<_Fields, org.apache.thrift.meta_data.FieldMetaData>(_Fields.class);
      tmpMap.put(_Fields.SUCCESS, new org.apache.thrift.meta_data.FieldMetaData("success", org.apache.thrift.TFieldRequirementType.DEFAULT, 
          new org.apache.thrift.meta_data.StructMetaData(org.apache.thrift.protocol.TType.STRUCT, com.wxmp.thrift.thriftdatatype.ResultInt.class)));
      metaDataMap = Collections.unmodifiableMap(tmpMap);
    ...
    public getInt_result(
      com.wxmp.thrift.thriftdatatype.ResultInt success)
    {
      this();
      this.success = success;
    }
    ...
    public getInt_result(getInt_result other) {
      if (other.isSetSuccess()) {
        this.success = new com.wxmp.thrift.thriftdatatype.ResultInt(other.success);
      }
    }
    ...
    public com.wxmp.thrift.thriftdatatype.ResultInt getSuccess() {
      return this.success;
    }

    public getInt_result setSuccess(com.wxmp.thrift.thriftdatatype.ResultInt success) {
      this.success = success;
      return this;
    }
    ...
    public void setFieldValue(_Fields field, Object value) {
      ...
      case SUCCESS:
        if (value == null) {
          ...
          setSuccess((com.wxmp.thrift.thriftdatatype.ResultInt)value);
        }
        break;
    ...
    private static class getInt_resultStandardScheme extends StandardScheme<getInt_result> {
      ...
      public void read(org.apache.thrift.protocol.TProtocol iprot, getInt_result struct) throws TException {
        org.apache.thrift.protocol.TField schemeField;
        iprot.readStructBegin();
        while (true)
        {
          ...
          switch (schemeField.id) {
            case 0: // SUCCESS
              if (schemeField.type == org.apache.thrift.protocol.TType.STRUCT) {
                struct.success = new com.wxmp.thrift.thriftdatatype.ResultInt();
                struct.success.read(iprot);
                struct.setSuccessIsSet(true);
              } else { 
                org.apache.thrift.protocol.TProtocolUtil.skip(iprot, schemeField.type);
      ...
      public void write(org.apache.thrift.protocol.TProtocol oprot, getInt_result struct) throws TException {
        struct.validate();
    ...
    private static class getInt_resultTupleScheme extends TupleScheme<getInt_result> {
      ...
      @Override
      public void write(org.apache.thrift.protocol.TProtocol prot, getInt_result struct) throws TException {
        TTupleProtocol oprot = (TTupleProtocol) prot;
        BitSet optionals = new BitSet();
        if (struct.isSetSuccess()) {
          optionals.set(0);
      ...
      @Override
      public void read(org.apache.thrift.protocol.TProtocol prot, getInt_result struct) throws TException {
        TTupleProtocol iprot = (TTupleProtocol) prot;
        BitSet incoming = iprot.readBitSet(1);
        if (incoming.get(0)) {
          struct.success = new com.wxmp.thrift.thriftdatatype.ResultInt();
